...
public class LyveSendSms {
	...
	public static String setOtp(String mobile, String otp) {
		...
		try {
			...
			/*String message = " Your OTP for password reset request at LYVE Poker is " + otp
	...
	public static String setOtpCSV(String mobile, String otp, String title) {
		...
		try {
			...
			String message = " Your OTP to download "+title+" is "+otp+". OTP is valid for next 3 min. Team LYVE Games";
	...
	public static String setOtpAffiliateCSV(String mobile, String otp, String title) {
		...
		try {
			...
			String message = " Your OTP to download Affiliate Players of "+title+" is "+otp+". OTP is valid for next 3 min. Team LYVE Games";
	...
	public static String sendbankDetailsApprovalConfirmation(String mobile, String accountNumber) {
		String difference = "failed";
		try {
			String message = " Your Account number " +accountNumber+ " has been Approved. Thank you for updating your Bank Account details.";
			String data = "";
			data += "method=sendMessage";
			data += "&userid=" + Config.OTPLoginId; // your loginId
			data += "&password=" + URLEncoder.encode(Config.OTPPassword, "UTF-8"); // your
	...
	public static String sendbankDetailsRejectionConfirmation(String mobile, String accountNumber) {
		String difference = "failed";
		try {
			String message = " Your Account Number " +accountNumber+ " has been Rejected due to discrepancies. Kindly resubmit with correct details.";
			String data = "";
			data += "method=sendMessage";
			data += "&userid=" + Config.OTPLoginId; // your loginId
			data += "&password=" + URLEncoder.encode(Config.OTPPassword, "UTF-8"); // your
	...
	public static String sendKYCRejectionConfirmation(String mobile, String kyc) {
		String difference = "failed";
		try {
			String message = " Your " +kyc+ " has been Rejected due to discrepancies. Kindly re-upload with correct KYC details.";
			String data = "";
			data += "method=sendMessage";
			data += "&userid=" + Config.OTPLoginId; // your loginId
			data += "&password=" + URLEncoder.encode(Config.OTPPassword, "UTF-8"); // your
	...
	public static String playerAchievement(String mobile, String type, Long point, String name, String achievementType,int value) {
		String difference = "failed";
		try {
			String message = " Congrats! "+point+" "+type+" chips awarded to you on "+achievementType+ " "+value+" "+name 
					+ ". Call us at 09051222225 for any assistance.";
			String data = "";
			data += "method=sendMessage";
			data += "&userid=" + Config.OTPLoginId; // your loginId
	...
	public static String sendSmsRedemptionReject(long mobile, long amount, Date date, String name) {
		...
		try {
			...
			//String message = " We have received your withdrawal revert request and the amount processing has been cancelled. Team LYVE Poker.";
			String data = ""; 
			data += "method=sendMessage";
			data += "&userid=" + Config.OTPLoginId; // your loginId
			data += "&password=" + URLEncoder.encode(Config.OTPPassword, "UTF-8"); // your
	...
	public static String sendSmsRedemptionExecute(String mobile, long amount, Date date, String name) {
		...
		try {
			...
			String message = " Your online redemption request dated "+requestDate+" for the Amount Rs "+amount+" have been processed successfully. Call us at +919051222225 for further assistance. Team LYVE Games.";
			String data = "";
			data += "method=sendMessage";
			data += "&userid=" + Config.OTPLoginId; // your loginId
			data += "&password=" + URLEncoder.encode(Config.OTPPassword, "UTF-8"); // your
	...
	public static String sendSmsRedemptionRequest(String mobile, long amount, String name) {
		String difference = "failed";
		try {
			String message = " Your redemption request of Rs "+amount+" have been received and the further details have been mailed to your email id. Team LYVE Games.";
	...
	public static String sendSignUpSms(String playerClass,String mobile) {
		String difference = "failed";
		try {
			String message = " Thank you for signing up for "+playerClass+" class. Further details have been mailed to your email id. Team LYVE Games.";
			//String message = " Thank you for signing up at LYVE Games. Please verify your account by completing the email verification link";
			String data = "";
			data += "method=sendMessage";
			data += "&userid=" + Config.OTPLoginId; // your loginId
			data += "&password=" + URLEncoder.encode(Config.OTPPassword, "UTF-8"); // your
	...
	public static String deployment(Date date, Date startTime, Date endTime,String mobile, String username) {
		...
		try {
			String message = "Dear "+username+", We are upgrading for a better gaming experience. Hence our Server will be down for merely from "+sTime+ " to "+ eTime+" on "+finalDate+". Inconvenience Regretted !! Team LYVE Games.";
			//String message = " Thank you for signing up at LYVE Games. Please verify your account by completing the email verification link";
			String data = "";
			data += "method=sendMessage";
			data += "&userid=" + Config.OTPLoginId; // your loginId
	...
	public static String sendSmsUpgradeClass(String mobile, PlayerClass newClass, String name) {
		String difference = "failed";
		try {
			String message = " Congratulations. That was an awesome move. You have now been upgraded to "+newClass+" class. Enjoy Playing  at LYVE Games.";
			String data = "";
			data += "method=sendMessage";
			data += "&userid=" + Config.OTPLoginId; // your loginId
			data += "&password=" + URLEncoder.encode(Config.OTPPassword, "UTF-8"); // your
	...
	public static String sendSmsFailedBuyIn(String mobile, String amount, String name) {
		...
		try {
			...
			//String message = " Oops! The payment transaction was incomplete. Please re-try or try another mode of payment. Team LYVE Poker.";
			String data = "";
			data += "method=sendMessage";
			data += "&userid=" + Config.OTPLoginId; // your loginId
			data += "&password=" + URLEncoder.encode(Config.OTPPassword, "UTF-8"); // your
	...
	public static String sendSmsSuccessBuyIn(String mobile, String amount, String name) {
		String difference = "failed";
		try {
			String message = " Thank you for purchasing real chips worth Rs "+amount+" at LYVE Games. The details of your purchase have been mailed to your email id. Team LYVE Games.";
	...
	public static String setOtpForWithdraw(String mobile, String otp) {
		...
		try {
			...
			//String message = " Your OTP for withdrawal request at LYVE Games is "+otp+". Call us at 09051222225 for any assistance. Team LYVE Games";
	...
	public static String setOtpForSignUp(String mobile, String otp) {
		String difference = "failed";
		try {
			//String message = " Your OTP for Signing Up at LYVE Games is "+otp+". Call us at 09051222225 for any assistance. Team LYVE Games";
