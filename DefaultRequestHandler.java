...
extends SimpleChannelInboundHandler<FullHttpRequest>
{
	...
	public void setSecuirtyHandler(SecuirtyHandler secuirtyHandler) {
	...
	throws Throwable
	{
		...
		Object result = context.getAction().invoke(context.getRequest(),
				context.getResponse(), secuirtyHandler);	
		if (result != null)
		{
